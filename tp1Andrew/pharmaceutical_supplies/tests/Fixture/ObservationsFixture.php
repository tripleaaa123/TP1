...
class ObservationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'observation' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'observations_ibfk_1' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['items', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-10-13 23:55:49',
                'modified' => '2019-10-13 23:55:49'
            ],
        ];
        parent::init();
    }
